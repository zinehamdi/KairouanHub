<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-6">
        <div class="mb-4">
            <a href="{{ route('admin.categories.create') }}" class="px-3 py-2 bg-indigo-600 text-white rounded">{{ __('buttons.create') }}</a>
        </div>
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="text-indigo-600">{{ __('buttons.edit') }}</a>
