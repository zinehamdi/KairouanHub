...
@section('content')
	<div class="min-h-screen bg-soft-cream py-12">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<!-- Header -->
			<div class="mb-8">
				<h1 class="text-4xl font-bold text-deep-blue mb-2">Admin Dashboard</h1>
				...
				<div class="card-mediterranean p-6">
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-3xl font-bold text-deep-blue mt-2">{{ $total_users }}</p>
						</div>
						<div class="w-16 h-16 bg-terracotta-gradient rounded-full flex items-center justify-center">
				...
				<div class="card-mediterranean p-6">
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-3xl font-bold text-deep-blue mt-2">{{ $total_providers }}</p>
						</div>
				...
				<div class="card-mediterranean p-6">
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-3xl font-bold text-deep-blue mt-2">{{ $total_services }}</p>
						</div>
						<div class="w-16 h-16 bg-terracotta-gradient rounded-full flex items-center justify-center">
							<svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
				...
				<div class="card-mediterranean p-6">
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-3xl font-bold text-deep-blue mt-2">{{ $total_categories }}</p>
						</div>
						<div class="w-16 h-16 bg-blue-gradient rounded-full flex items-center justify-center">
							<svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
				...
				<div class="card-mediterranean p-6">
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-3xl font-bold text-deep-blue mt-2">{{ $total_requests }}</p>
						</div>
						<div class="w-16 h-16 bg-terracotta-gradient rounded-full flex items-center justify-center">
							<svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
				...
				<div class="card-mediterranean p-6">
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-3xl font-bold text-terracotta mt-2">{{ $pending_requests }}</p>
						</div>
						<div class="w-16 h-16 bg-blue-gradient rounded-full flex items-center justify-center">
							<svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
			...
			<!-- Quick Actions -->
			<div class="mb-8">
				<h2 class="text-2xl font-bold text-deep-blue mb-4">إجراءات سريعة</h2>
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
					...
					<a href="{{ route('providers.index') }}" class="btn-outline-mediterranean text-center">
						عرض المقدمين
					</a>
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
				<!-- Recent Users -->
				<div class="card-mediterranean p-6">
					<h3 class="text-xl font-bold text-deep-blue mb-4">آخر المستخدمين</h3>
					<div class="space-y-3">
						@forelse($recent_users as $user)
							<div class="flex items-center justify-between p-3 bg-soft-cream rounded-lg">
								<div class="flex items-center gap-3">
									<div class="w-10 h-10 bg-terracotta-gradient rounded-full flex items-center justify-center">
										<span class="text-white font-bold">{{ substr($user->name, 0, 1) }}</span>
									</div>
									<div>
										<p class="font-semibold text-deep-blue">{{ $user->name }}</p>
				...
				<!-- Recent Requests -->
				<div class="card-mediterranean p-6">
					<h3 class="text-xl font-bold text-deep-blue mb-4">آخر الطلبات</h3>
					<div class="space-y-3">
						@forelse($recent_requests as $request)
							<div class="p-3 bg-soft-cream rounded-lg">
								<div class="flex items-center justify-between mb-2">
									<p class="font-semibold text-deep-blue">{{ $request->user->name }}</p>
