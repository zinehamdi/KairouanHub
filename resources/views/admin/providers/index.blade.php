            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('admin.providers.map-import') }}"
                        class="inline-flex items-center px-5 py-3 border-2 border-accent-DEFAULT text-accent-DEFAULT font-bold rounded-xl hover:bg-accent-DEFAULT hover:text-white transition-all"
                        title="{{ __('admin.import_from_map', ['default' => 'Import from Google Maps']) }}">
                        ...
                        <thead style="background: linear-gradient(135deg, #E07A5F 0%, #F4A261 100%);">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">
                                    Provider</th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Email
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Phone
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">
                                    Services</th>
                                ...
                                <tr class="hover:bg-kairouan-warm-cream/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-brand-dark">{{ $provider->user->name }}
                                                </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="{{ route('admin.providers.show', $provider) }}"
                                                class="hover:scale-110 transition-transform" style="color: #E07A5F;"
                                                title="View">
                                            ...
                                            <form action="{{ route('admin.providers.destroy', $provider) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="text-red-600 hover:text-red-800 hover:scale-110 transition-all"
                                                    title="Delete">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
