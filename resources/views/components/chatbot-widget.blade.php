<div x-data="chatbotWidget()" x-init="init()" class="fixed z-50">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300 transform"
        ...
        <div
            class="relative overflow-hidden bg-gradient-to-br from-accent-DEFAULT via-accent-amber to-kairouan-brass px-6 py-5">
            ...
            <div class="relative flex items-center justify-between text-white">
                <div class="flex items-center gap-3">
                    <div
                        class="w-11 h-11 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-lg">
                    ...
                    <div>
                        <h3 class="font-bold text-lg">مساعد KairouanHub</h3>
                        <p class="text-xs text-white/80">ذكاء اصطناعي 🤖</p>
                    </div>
                </div>
        ...
        <div class="h-[450px] flex flex-col bg-gradient-to-b from-kairouan-warm-cream/20 to-white">
            <div id="chat-scroll"
                class="flex-1 overflow-y-auto p-5 space-y-4 scrollbar-thin scrollbar-thumb-accent-DEFAULT/20 scrollbar-track-transparent">
                ...
                <template x-if="messages.length===0">
                    <div class="flex items-center justify-center h-full">
                        <div class="text-center px-6">
                            <div
                                class="w-20 h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-accent-DEFAULT/10 to-accent-amber/10 flex items-center justify-center">
                                <svg class="w-10 h-10 text-accent-DEFAULT" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />
                                </svg>
                            </div>
                            <h4 class="font-bold text-lg text-brand-dark mb-2">كيفاش نقدر نعاونك اليوم؟</h4>
                            <p class="text-sm text-gray-500">اسألني على أي خدمة في KairouanHub</p>
                        </div>
                    </div>
                </template>
                    ...
                    <div class="flex justify-start">
                        <div class="bg-white border-2 border-kairouan-limestone/50 shadow-md px-5 py-3.5 rounded-2xl">
                            <div class="flex gap-1.5">
                                <div class="w-2 h-2 bg-accent-DEFAULT rounded-full animate-bounce"
    ...
    <button @click="toggle"
        ...
        <div class="relative">
            ...
            <span x-show="messages.length > 0"
                class="absolute -top-1 -right-1 w-3 h-3 bg-white rounded-full animate-pulse"></span>
        </div>
        <span class="text-lg">شات</span>
    </button>
