            ...
            <div class="flex items-center">
                ...
                <div class="hidden space-x-6 rtl:space-x-reverse sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <a href="{{ route('provider.start') }}"
                        class="inline-flex items-center px-4 py-2.5 bg-terracotta hover:bg-opacity-90 text-white font-semibold rounded-lg shadow-md transition-all duration-200 hover:shadow-lg">
