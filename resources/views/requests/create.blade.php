        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-lg text-gray-600">
                    {{ __('Tell us what you need and receive proposals from qualified providers') }}</p>
            </div>
            ...
            @guest
                ...
                <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
                    ...
                    <div class="flex gap-4 justify-center">
                        <a href="{{ route('login') }}"
                            class="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-lg shadow-lg hover:shadow-xl transition-all">
                            {{ __('Login') }}
                        </a>
                        <a href="{{ route('register') }}"
                            class="px-8 py-3 bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-bold rounded-lg shadow-lg hover:shadow-xl transition-all">
                            {{ __('Register') }}
                        </a>
                    </div>
                </div>
            @else
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8" x-data="{
                             cat: '{{ $targetProvider ? $targetProvider->category_id : "" }}', 
                    ...
                    <form method="POST" action="{{ route('requests.store') }}" enctype="multipart/form-data" class="space-y-8">
                        ...
                        @if(isset($targetProvider))
                            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img class="h-10 w-10 rounded-full object-cover" src="{{ $targetProvider->avatar_url }}"
                                            alt="{{ $targetProvider->display_name }}">
                                    </div>
                                    <div class="ml-3">
                                        <p class="text-sm text-blue-700">
                                            {{ __('Requesting a quote directly from') }} <span
                                                class="font-bold">{{ $targetProvider->display_name }}</span>
                                        </p>
                                    </div>
                                </div>
                                <input type="hidden" name="provider_id" value="{{ $targetProvider->id }}">
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                {{ __('Select a specific service or leave general for the category') }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="mb-2 text-sm text-gray-600 font-semibold">{{ __('Click to upload photos') }}
                                        </p>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                <svg class="w-4 h-4 inline-block mr-1 rtl:ml-1 rtl:mr-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            ...
                            <button type="submit"
                                ...
                                <svg class="w-6 h-6 inline-block mr-2 rtl:ml-2 rtl:mr-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
